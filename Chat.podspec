...
Pod::Spec.new do |s|
  ...
  s.name         = "Chat"
  s.version      = "0.0.1"
  s.summary      = "A short description of Chat."

  s.description  = <<-DESC
                   A longer description of Chat in Markdown format.
  ...
  #s.source       = { :git => "http://EXAMPLE/Chat.git", :tag => "0.0.1" }
  ...
  s.dependency  'EaseMobSDK', :podspec => "https://github.com/winterSleep/EasemobSDK/blob/master/Easemob.podspec"
